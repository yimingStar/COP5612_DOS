(function(Global)
{
 ...
 Client.SignUpComponent$20$20=function(rvResponse)
 {
  return function(e)
  {
   ...
   Concurrency.StartImmediate((b=null,Concurrency.Delay(function()
   {
    return Concurrency.Bind((new AjaxRemotingProvider.New()).Async("twitter-client:twitter_client.CallApi.RequestRegister:-1794501434",[e.Vars.Hole("account").$1.Get()]),function(a)
    {
     rvResponse.Set(a);
     return Concurrency.Zero();
    });
